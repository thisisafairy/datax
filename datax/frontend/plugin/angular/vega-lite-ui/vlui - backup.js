...
$templateCache.put("components/schemalist/schemalist.html","<div class=\"schema no-top-margin full-width  scroll-y\"><schema-list-item ng-repeat=\"fieldDef in fieldDefs | orderBy : orderBy\" field-def=\"fieldDef\" filter-manager=\"filterManager\" show-add=\"showAdd\"></schema-list-item><schema-list-item ng-if=\"showCount\" field-def=\"countFieldDef\" show-add=\"true\"></schema-list-item><div class=\"schema-list-drop\" ng-show=\"showDrop\" ng-model=\"droppedFieldDef\" data-drop=\"true\" jqyoui-droppable=\"{onDrop:\'fieldDropped\'}\" data-jqyoui-options=\"{activeClass: \'drop-active\'}\">Create a new wildcard.</div></div>");
...
$templateCache.put("components/shelves/shelves.html","<div class=\"card vflex shelves no-top-margin no-right-margin abs-100\"><div class=\"shelf-pane shelf-encoding-pane full-width\"> <a class=\"right\" ng-click=\"showtype()\"><i class=\"fa fa-tag\"></i></a> <a style='padding-left:3px;' class=\"right\" ng-click=\"chron.undo()\" ><i class=\"fa fa-undo\"></i><small>撤销</small></a><a style='padding-left:3px;' class=\"right\" ng-click=\"chron.redo()\" ><i class=\"fa fa-repeat\"></i><small>还原</small></a>  <a class=\"right\" ng-click=\"clear()\"><i class=\"fa fa-eraser\"></i> 清空</a> <h2>属性</h2><div class=\"shelf-pane shelf-positional-pane full-width\"><channel-shelf lang=\"\'X轴\'\" channel-id=\"\'x\'\" preview=\"preview\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\"></channel-shelf><channel-shelf lang=\"\'Y轴\'\" channel-id=\"\'y\'\" preview=\"preview\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\"></channel-shelf><channel-shelf lang=\"\'列\'\" channel-id=\"\'column\'\" preview=\"preview\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\" disabled=\"!spec.encoding.x.field\">></channel-shelf><channel-shelf lang=\"\'行\'\" channel-id=\"\'row\'\" preview=\"preview\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\" disabled=\"!spec.encoding.y.field\"></channel-shelf></div><div class=\"shelf-pane shelf-marks-pane full-width\"><div class=\"right\"><select class=\"markselect\" ng-model=\"spec.mark\" ng-class=\"{auto: spec.mark === ANY}\" ng-options=\"(type === ANY ? \'自动\' : type) for type in (supportAny || supportAutoMark ? marksWithAny : marks)\" ng-change=\"markChange()\"></select></div><h3>标记</h3><channel-shelf channel-id=\"\'size\'\" lang=\"\'尺寸\'\" preview=\"preview\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\"></channel-shelf><channel-shelf channel-id=\"\'color\'\" lang=\"\'颜色\'\" preview=\"preview\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\"></channel-shelf><channel-shelf channel-id=\"\'shape\'\" lang=\"\'形状\'\" preview=\"preview\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\"></channel-shelf><channel-shelf lang=\"\'详细\'\"   channel-id=\"\'detail\'\" preview=\"preview\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\"></channel-shelf><channel-shelf lang=\"\'文本\'\" channel-id=\"\'text\'\" preview=\"preview\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\"></channel-shelf></div><div class=\"shelf-pane shelf-any-pane full-width\" ng-if=\"supportAny && !preview\"><br><channel-shelf ng-repeat=\"channelId in anyChannelIds\" preview=\"preview\" channel-id=\"channelId\" encoding=\"spec.encoding\" support-any=\"supportAny\" mark=\"spec.mark\"></channel-shelf></div></div><div class=\"shelf-pane shelf-filter-pane full-width\" ng-if=\"!preview\"><filter-shelves spec=\"spec\"></filter-shelves></div></div>");
...
angular.module('vlui').constant('SampleData', [{
  ...
  url: '/frontend/data/barley.json',
  id: 'barley',
  group: 'sample'
},{
  name: 'Cars',
  description: 'Automotive statistics for a variety of car models between 1970 & 1982',
  url: '/frontend/data/cars.json',
  id: 'cars',
  group: 'sample'
},{
  name: 'Crimea',
  url: '/frontend/data/crimea.json',
  id: 'crimea',
  group: 'sample'
},{
  name: 'Driving',
  url: '/frontend/data/driving.json',
  id: 'driving',
  group: 'sample'
},{
  name: 'Iris',
  url: '/frontend/data/iris.json',
  id: 'iris',
  group: 'sample'
},{
  name: 'Jobs',
  url: '/frontend/data/jobs.json',
  id: 'jobs',
  group: 'sample'
},{
  name: 'Population',
  url: '/frontend/data/population.json',
  id: 'population',
  group: 'sample'
},{
  name: 'Movies',
  url: '/frontend/data/movies.json',
  id: 'movies',
  group: 'sample'
},{
  name: 'Birdstrikes',
  url: '/frontend/data/birdstrikes.json',
  id: 'birdstrikes',
  group: 'sample'
},{
  name: 'Burtin',
  url: '/frontend/data/burtin.json',
  id: 'burtin',
  group: 'sample'
},{
  name: 'Campaigns',
  url: '/frontend/data/weball26.json',
  id: 'weball26',
  group: 'sample'
}]);
}());
...
angular.module('vlui')
  .service('FilterManager', ['_', 'vl', 'Dataset', 'Logger', function (_, vl, Dataset, Logger) {
    ...
    this.add = function(field) {
      ...
      else if(self.filterIndex[field]&&!self.filterIndex[field].enabled)
      {
