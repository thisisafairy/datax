...
var coordinate = [
	{
		"name": "辽宁沿海", "log": "121.62", "lat": "38.92", "children": [
			{ "name": "辽宁沿海", "log": "121.62", "lat": "38.92" },
			{ "name": "丹东", "log": "124.37", "lat": "40.13" },
			{ "name": "营口、盘锦", "log": "122.18", "lat": "40.65" },
			{ "name": "庄河", "log": "22.97", "lat": "39.7" },
			{ "name": "锦州", "log": "121.15", "lat": "41.13" },
			{ "name": "大连", "log": "121.62", "lat": "38.92" },
			{ "name": "绥中", "log": "120.32", "lat": "40.35" },
			{ "name": "其它", "log": "123.38", "lat": "41.8" }
		]
	},
	{
		"name": "天津", "log": "117.2", "lat": "39.13", "children": [
			{ "name": "天津", "log": "117.2", "lat": "39.13" }
		]
	},
	{
		"name": "河北沿海", "log": "119.57", "lat": "39.95", "children": [
			{ "name": "河北沿海", "log": "119.57", "lat": "39.95" },
			{ "name": "秦皇岛、山海关", "log": "119.57", "lat": "39.95" },
			{ "name": "黄骅", "log": "117.33", "lat": "38.4" },
			{ "name": "曹妃甸", "log": "118.39", "lat": "39.13" },
			{ "name": "其它", "log": "114.48", "lat": "38.03" }
		]
	},
	{
		"name": "山东", "log": "117", "lat": "36.65", "children": [
			{ "name": "山东", "log": "117", "lat": "36.65" },
			{ "name": "潍坊", "log": "119.1", "lat": "36.62" },
			{ "name": "滨州、东营", "log": "118.03", "lat": "37.36" },
			{ "name": "烟台", "log": "121.39", "lat": "37.52" },
			{ "name": "威海", "log": "122.1", "lat": "37.5" },
			{ "name": "青岛", "log": "120.33", "lat": "36.07" },
			{ "name": "日照", "log": "119.46", "lat": "35.42" },
			{ "name": "京杭运河（山东段）", "log": "116.59", "lat": "35.38" },
			{ "name": "其它", "log": "106.54", "lat": "29.59" }
		]
	},
	{
		"name": "江苏", "log": "120.62", "lat": "31.32", "children": [
			{ "name": "江苏", "log": "120.62", "lat": "31.32" },
			{ "name": "连云港", "log": "119.16", "lat": "34.59" },
			{ "name": "南通", "log": "120.86", "lat": "32.01" },
			{ "name": "大丰", "log": "120.45", "lat": "33.19" },
			{ "name": "京杭运河（江苏段）", "log": "119.42", "lat": "32.39" },
			{ "name": "其它", "log": "118.78", "lat": "32.04" }
		]
	},
	{
		"name": "上海", "log": "121.48", "lat": "31.22", "children": [
	...
	{
		"name": "浙江沿海", "log": "120.19", "lat": "30.26", "children": [
			{ "name": "浙江沿海", "log": "120.19", "lat": "30.26" },
			{ "name": "舟山", "log": "122.32", "lat": "29.95" },
			{ "name": "宁波", "log": "121.56", "lat": "29.86" },
			{ "name": "台州", "log": "121.49", "lat": "28.67" },
			{ "name": "温州", "log": "120.65", "lat": "28.01" },
			{ "name": "其它", "log": "120.19", "lat": "30.26" }
		]
	},
	{
		"name": "福建", "log": "119.3", "lat": "26.08", "children": [
			{ "name": "福建", "log": "119.3", "lat": "26.08" },
			{ "name": "福州", "log": "119.3", "lat": "26.08" },
			{ "name": "厦门", "log": "118.1", "lat": "24.46" },
			{ "name": "泉州", "log": "118.58", "lat": "24.93" },
			{ "name": "其它", "log": "119.3", "lat": "26.08" },
		]
	},
	{
		"name": "广东沿海", "log": "113.23", "lat": "23.16", "children": [
			{ "name": "广东沿海", "log": "113.23", "lat": "23.16" },
			...
			{ "name": "其它", "log": "113.23", "lat": "23.16" }
		]
	},
	{
		"name": "广西沿海", "log": "106.54", "lat": "29.59", "children": [
			{ "name": "广西沿海", "log": "106.54", "lat": "29.59" },
	...
	{
		"name": "海南", "log": "110.35", "lat": "20.02", "children": [
			{ "name": "海南", "log": "110.35", "lat": "20.02" }
		]
	},
	{
		"name": "长江", "log": "114.31", "lat": "30.52", "children": [
			{ "name": "长江", "log": "114.31", "lat": "30.52" },
			{ "name": "长江上游（鄂湘川渝云贵）", "log": "106.54", "lat": "29.59" },
			{ "name": "长江下游（赣苏皖浙）", "log": "117.27", "lat": "31.86" },
			{ "name": "其它", "log": "114.31", "lat": "30.52" }
		]
	},
	{
		"name": "黄淮河沿线", "log": "103.73", "lat": "36.03", "children": [
			{ "name": "黄淮河沿线", "log": "103.73", "lat": "36.03" },
			{ "name": "黄淮沿线（青甘蒙豫皖等）", "log": "103.73", "lat": "36.03" }
		]
	},
	{
		"name": "东北内河", "log": "123.97", "lat": "47.33", "children": [
			{ "name": "东北内河", "log": "123.97", "lat": "47.33" },
			{ "name": "黑龙江", "log": "126.63", "lat": "45.75" },
			{ "name": "吉林", "log": "125.35", "lat": "43.88" },
			{ "name": "内蒙古", "log": "111.65", "lat": "40.82" },
			{ "name": "辽宁", "log": "123.38", "lat": "41.8" }
		]
	},
	{
		"name": "江西内河", "log": "115.89", "lat": "28.68", "children": [
			{ "name": "江西内河", "log": "115.89", "lat": "28.68" }
		]
	},
	{
		"name": "湖南内河", "log": "113", "lat": "28.21", "children": [
			{ "name": "湖南内河", "log": "113", "lat": "28.21" }
		]
	},
	{
		"name": "贵州内河", "log": "106.71", "lat": "26.57", "children": [
			{ "name": "贵州内河", "log": "106.71", "lat": "26.57" }
		]
	},
	{
		"name": "华南内河", "log": "110.28", "lat": "25.29", "children": [
			{ "name": "华南内河", "log": "110.28", "lat": "25.29" },
			{ "name": "珠江、西江内河", "log": "111.34", "lat": "23.51" }
		]
	},
	{
		"name": "海外", "log": "-1", "lat": "-1", "children": [
			{ "name": "海外", "log": "-1", "lat": "-1" }
		]
	},
	{
		"name": "北京", "log": "116.46", "lat": "39.92", "children": [
			{ "name": "北京", "log": "116.46", "lat": "39.92" }
		]
	},
	{
		"name": "西北及新疆", "log": "101.74", "lat": "36.56", "children": [
			{ "name": "西北及新疆", "log": "101.74", "lat": "36.56" },
			{ "name": "山西", "log": "112.53", "lat": "37.87" },
			{ "name": "陕西", "log": "108.95", "lat": "34.27" },
			{ "name": "宁夏", "log": "106.27", "lat": "38.47" },
			{ "name": "新疆", "log": "87.68", "lat": "43.77" },
			{ "name": "甘肃", "log": "103.73", "lat": "36.03" }
		]
	},
	{
